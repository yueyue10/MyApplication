...
class ClassAndObject {
    ...
    private fun classProperty() {
        ...
        class NoPerson(firstName: String) {
        }
    }
     ...
     * 四、GetSet方法测试
     */
    private fun getSetTest() {
        println("四、GetSet方法测试")
        class Person {
     ...
     * 六、次构造函数
     */
    private fun secondConstruction() {
        println("六、次构造函数")
        /*类也可以有二级构造函数，需要加前缀 constructor:*/
        /*class APerson {
            constructor(parent: APerson) {
    ...
    private fun innerClass() {
        ...
        fun test() {
            ...
            println("输出方法返回值：$demo2")   // 内部类可以引用外部类的成员，例如：成员属性
            val demo3 = Outer().Inner().zyjTest()
            println("输出方法返回值：$demo3")   // 内部类可以引用外部类的成员，例如：成员属性
        }
        test()
