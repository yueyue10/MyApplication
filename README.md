...
<div align="center">
<p align="center">点击“新增偏航数据”按钮后，进入行程提醒界面可看到新增的数据。再次点击“新增偏航数据”按钮后，新城提醒界面数据更新可进入查看</p>
...
<div align="center">
<p align="center">点击“新增推荐数据”按钮后，进入精彩推荐和景点播报界面可看到新增的数据。再次点击“新增推荐数据”按钮后，数据不更新内部方法已经报错。</p>
...
<div align="center">
<p align="center">点击“新增推荐数据”或者“新增推荐数据”按钮后，都会将json数据保存到数据库。可以进入导引消息界面查看。</p>
